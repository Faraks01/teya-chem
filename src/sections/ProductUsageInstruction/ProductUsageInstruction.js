      ...
      >
        ...
        >
          ...
          <Box position="absolute" top={0} bottom={0} left={0} right={0}>
            ...
            >
              <path
                d="M0 241.009V36.7616V22C0 9.84973 9.84973 0 22 0H278C290.15 0 300 9.84975 300 22V47.0066V263C300 275.15 290.15 285 278 285H53.3873C48.8702 285 44.4627 283.61 40.7633 281.018L9.376 259.026C3.49937 254.909 0 248.184 0 241.009Z"
                fill="#FFE898"
              />
            </svg>
          </Box>
        ...
        <Box height={{ xs: "67px", md: "108.33px" }} />
        ...
        >
          {stepCardsData.map((data, index) => {
            ...
            return (
              <Grid key={key} cardKey={data.key} sm={6} md={3}>
                <InstructionStepCard
